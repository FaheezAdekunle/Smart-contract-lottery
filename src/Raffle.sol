...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    // when should this winner be picked
    /**
     * @dev This is the functon that the chainlink nodes wil call to see if the lottery is ready to have winner picked.
    ...
    // This function was formally known as pickWinner, but it has been refactored for the sake of automation
